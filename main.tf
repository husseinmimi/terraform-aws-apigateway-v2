...
resource "aws_apigatewayv2_integration" "this" {
  ...
  dynamic "tls_config" {
    for_each = each.value["tls_config"] != {} ? merge({}, {tls_condig = each.value["tls_config"]}) : {}
  ...
  dynamic "response_parameters" {
    for_each = each.value["response_parameters"]  != {} ? merge({}, {response_parameters = each.value["response_parameters"]}) : {}
